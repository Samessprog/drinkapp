        ...
        <main className="main d-flex row justify-content-center me-0 ">
            ...
            {!drinkNotFound &&
                ...
                <Pagination
                    ...
                    nextLabel={<svg className= "arrowPagination" xmlns="http://www.w3.org/2000/svg" height="40" width="40"><path className= "arrowPagination" d="m15.625 30-1.958-1.958 8.041-8.084-8.041-8.041 1.958-1.959 10.042 10Z" /></svg>}
