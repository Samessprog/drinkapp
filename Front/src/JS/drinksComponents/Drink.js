...
function Drink({ setDrinkDetailsPopup, elm }) {
    ...
    return (
        ...
        <Link className="main d-flex row justify-content-center"  to={`drinkDetail/${elm.ID_Drink}`} >
            <div onClick={() => setDrinkDetailsPopup(true)} className=" drin-window col-7 col-sm-6 col-md-5 col-lg-4 col-xl-3 col-xxl-2 col p-1 rounded m-3 ">
                ...
                <div className="basic-information-drink p-2">
                    <div className="d-flex justify-content-between  align-items-center ">
                        <label className="fs-4 fw-bolder">{elm.DrinkName}</label>
                    ...
                    <div className="d-flex  mt-3  justify-content-evenly">
                        ...
                        <label className="bg-primary rounded-pill p-1 fw-bolder ">{elm.DrinkType}</label>
                    </div>
