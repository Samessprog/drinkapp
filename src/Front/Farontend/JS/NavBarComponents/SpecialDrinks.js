...
function SpecialDrinks({ setSearchingDrink, setSpecialOptionsPopup, drinkDatas, setDrinkNotFound }) {
    ...
    return (
        <div ref={settingsRef} className=" col-sm-12 special-drinks-holder position-fixed mt-5 " style={{ textAlign: "center" }}>
            ...
            >
                ...
                <div className="col-12 d-flex justify-content-center mb-3 align-items-center mt-3 mb-3">
                    <input
                        ...
                        className="col-9 mt-4 mt-sm-0 col-sm-6 ingredients-input ps-3 "
                        type="text" placeholder="Enter your ingredients">
                    </input>
                    <button
                        onClick={submitIngredientHandler}
                        className="ing-button mt-4 mt-sm-0">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            height="24" viewBox="0 -960 960 960" width="24">
                            <path d="M440-280h80v-160h160v-80H520v-160h-80v160H280v80h160v160Zm40 200q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z" />
                ...
                <div className="d-flex justify-content-center align-items-center mb-2 flex-column-reverse  flex-column ">
                    ...
                    {
                        !eachdrinkflag ? (
                            <label className="ms-2 mt-3 mt-sm-2 special-options-holder">Search for ALL drinks with the given ingredients</label>
                        ) : (
                            <label className="ms-2 mt-3 mt-sm-2 special-options-holder">Search for ONLY drinks with the given ingredients</label>
                        )
                    }
                </div>
                <div className="col-12 justify-content-between align-items-center d-flex">
                    <div className="col-12 col-lg-9 test overflow-auto pe-2">
                        <label className="d-flex ms-5 mb-3 fs-5 fs-lg-4 justify-content-center justify-content-sm-start"> Your ingredients:</label>
                    ...
                    <div className="col-2 d-none d-lg-block">
                        <svg className="special-drink-ing-icon" height="150px" width="150px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 314.862 314.862" link="http://www.w3.org/1999/xlink" enableBackground="new 0 0 314.862 314.862">
