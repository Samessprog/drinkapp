...
function SetingsPopup({ setSpecialOptionsPopup, setPopupSetings, specialOptionsPopup, searchingDrink,
    ...
    return (
        <div ref={settingsRef} className="col-11 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-2 position-fixed SetingsPopupHolder">
            ...
            <div className="d-flex flex-row-reverse me-2 mt-2 ">
                <svg
                    ...
                    onClick={() => dispatch(setPopupSetings(false))}
            ...
            <div className="ms-2 p-2 pe-3 ">
                ...
                <div className="d-flex justify-content-center advanced-button-holder mb-2 mt-4">
                    <button onClick={() => {
                        ...
                        <svg
                            className="me-1 fill-color-212 ms-2 me-2 advancet-filter-icon"
                            xmlns="http://www.w3.org/2000/svg"
                            height="24" viewBox="0 -960 960 960" width="24">
