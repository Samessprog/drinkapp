        ...
        <nav className="NavBar position-sticky top-0 ">
            ...
            <div className="col-12 NavBarContentHolder p-3 pb-0">
                <div className={`col-12 d-flex align-items-center ${userScroll ? 'pb-sm-3 pb-0' : 'pb-0'}`} >
                    ...
                    <div
                        id="hamburger"
                        className={userScroll ? ` col-xl-4 col-xxl-3 d-flex mb-3 align-items-center mt-3 align-items-center ${location.pathname.endsWith('/') ? '' : 'col-sm-8 col-md-10 col-xl-9 col-xxl-3 col-9'} ` : `hamburger-SCROLL  mt-3 mb-3  ${location.pathname.endsWith('/') ? `` : `col-9 col-sm-8 col-md-10 col-xxl-6 `}`} onClick={(() => { const navbarLinks = document.getElementsByClassName('main-options-holder')[0]; navbarLinks.classList.toggle('d-none'); handlePopup('menu') })}>
                        <div
                        ...
                        >
                            <span className="bar w-100 rounded-pill bg-light mb-0 pb-0"></span>
                    ...
                    {location.pathname.endsWith('/') &&
                        <div className={`d-flex me-3 col-8 col-sm-7 col-sm-7 col-md-9 col-xl-6 justify-content-center justify-content-xl-start  ${userScroll ? 'justify-content-xl-center  col-xl-5 ' : 'justify-content-center'}`}>
                            {/* Wyszukiwarka drinków  */}
                            <div className="col-10 col-sm-8 col-md-8 col-xl-9 searching-holder  ms-3 d-flex align-items-center pt-2 d-flex ">
                                ...
                                <div className="options-holder ">
                                    <button
                                        className="mb-md-2 ms-1 d-none d-md-flex rounded-pill btn btn-secondary bg-transparent border rounded d-flex p-2"
                                        onClick={() => handlePopup('settings')}>
                    ...
                    <div className={`d-flex justify-content-center justify-content-sm-end  pe-2 pt-36 mt-3 col-sm-4 col-md-2  col-2  ${userScroll ? `col-xl-2 col-xxl-3  ${location.pathname.endsWith('/') ? '' : 'col-2 col-xxl-9'}` : `  ${location.pathname.endsWith('/') ? '  ' : 'col-2 col-xxl-8'}`}`}>
                        {userSesion === null &&
                            <button
