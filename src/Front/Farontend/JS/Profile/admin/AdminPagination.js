...
import { setAnnouncementSuccess } from '../../States/actions'


function AdminPagination({ setChangeUserDataPopup, setDrinkPreview, showNewsFlag, currentPaginationItem,
    hiddenElements, setWindowAlert, windowAlert, setBlockedButton, pageCountItem, setCurrentPage, ComponentRender }) {
