...
function AdminFilter({ showDrinksOptions, drinksFlag, usersFlag, showNewsFlag, setShowDrinksOptions, setAlphabeticalOrder,
    ...
    return (
        <div
            ref={filterRef}
            className="data-filtering-holder  ms-3 pt-2"
        >
            <div
                className="options-holder d-none d-md-flex"
                onClick={() => setShowDrinksOptions(!showDrinksOptions)}
            >
                <button
                    className="mb-md-2 ms-1 btn btn-secondary bg-transparent border d-flex p-2"
                    style={{ borderRadius: '15px' }}
                >
                    <svg
                        className="me-1 fill-color-212 ms-2 me-2"
                ...
                <div className="multi-options-holder-admin col-2">
                    <div className="ps-3 pt-3 pb-3">
                        <div className="mt-1">
                            <input
                                type="checkbox"
                                onChange={() => setAlphabeticalOrder(!alphabeticalOrder)}
                            >
                            </input>
                        ...
                        <div className="mt-1">
                            <input
                                type="checkbox"
                                onChange={() => setUnAlphabeticalOrder(!unAlphabeticalOrder)}
                            >
                            </input>
