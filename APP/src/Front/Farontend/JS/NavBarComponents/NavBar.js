        ...
        <nav className="NavBar position-sticky top-0 ">
            ...
            <div className="col-12 NavBarContentHolder p-3 pb-0">
                <div className={`col-12 d-flex align-items-center ${userScroll ? 'pb-3' : 'pb-0'}`} >
                    ...
                    <div id="hamburger" className={userScroll ? `col-xl-4 col-xxl-3 d-flex mb-3 align-items-center mt-3 align-items-center ${location.pathname.endsWith('/') ? '' : 'col-8 col-sm-8 col-md-10 col-xl-9 col-xxl-3'} ` : `hamburger-SCROLL  mt-3 mb-3 ${location.pathname.endsWith('/') ? `` : `col-8 col-sm-8 col-md-10 col-xxl-6 `}`} onClick={(() => { const navbarLinks = document.getElementsByClassName('main-options-holder')[0]; navbarLinks.classList.toggle('d-none'); handlePopup('menu') })}>
                        <div
