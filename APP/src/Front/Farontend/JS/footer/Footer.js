    ...
    return (
        <footer className={searchingDrink >= 6 ? 'mt-5  col-12 position-absolute top-100' : 'mt-5  col-12 '}>
            <div className="footer pt-5 ps-3 d-flex flex-column   align-items-center  align-items-md-start flex-md-row   pe-4">
                <div className='col-2 ms-4 d-none d-lg-block' >
                    <div>
                        <img className='drink-footer-img img-fluid' style={{ objectFit: "cover" }} src={drinkIMG}></img>
                    </div>
                </div>
                <div className='d-flex col-12 col-lg-10 flex-column flex-lg-row align-items-center' >
                    <div className="mb-2 col-4 d-flex flex-column col-12 col-lg-4 align-items-center">
                    ...
                    <div className='d-flex align-items-center flex-column mt-2 ol-12 col-lg-4 align-items-center'>
                        <label className='fs-4 drink-count ' >Total number of drinks</label>
                        <div className='d-flex mt-2  drink-count-number'>
                            <CountUp
                                start={drinkDatas + 10}
                                end={drinkDatas}
                                duration={4}
                    ...
                    <div className='d-flex col-4 justify-content-end  ps-3 p mt-3'>
                        <div className="mb-2  col-6 d-flex flex-row-reverse pe-5">
                            <div>
