...
function Registers() {
    ...
    return (
        <div className="position-fixed loginPopupHolder d-flex  align-items-center  flex-column col-5 col-4 col-12 col-md-6 col-lg-4">
            ...
            <div className="test rounded col-12">
                    ...
                    <div className="test col-12 d-flex  justify-content-center flex-column align-items-center mt-5 logRegHolder">
                        ...
                        <div className="col-9 d-flex  align-items-center mb-2 mt-3">
                            ...
                            <div className="input-box col-11">
                                <input onChange={(event) => dispatch(setEmail(event.target.value))} className=" ps-2 rounded col-11 login-register-input-data" type="text" placeholder="Email"></input>
                            </div>
                        </div>
