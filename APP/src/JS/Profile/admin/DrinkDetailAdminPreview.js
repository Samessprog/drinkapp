...
function DrinkDetailAdminPreview({ DrinkPreview, setDrinkPreview }) {
    ...
    console.log(DrinkPreview.Drink)
            ...
            <div>
                ...
                <div className="data-drink-holder d-flex justify-content-evenly ">
                    <div className="polowa1 col-6">
                        ...
                        <div className="mt-4">
                            <label className="fs-3">History</label>
                            <div className="description-holder mt-2 col-10 text-break pe-3
                            ">
                    ...
                    <div className="polowa2 col-6 align-items-center">
                        <div className="photo-holder img-fluid">
                            <div>
                                <img src={convertetIMG} className="img-fluid card" ></img>
                            </div>
                        </div>
                        <div className="mt-4 d-flex flex-column align-items-center">
                            <label className="fs-4 mb-3 ">Specifications</label>
                            <div className="d-flex">
                                ...
                                <div >
                                    <label className={DrinkPreview.Drink.Taste === 'Sour' ? 'sourClass me-2' : DrinkPreview.Drink.Taste === 'Sweet' ? 'sweetClass me-2' : drinksDetail.drinkType === 'Bitter' ? 'bitterClass me-2' : ''}>{DrinkPreview.Drink.Taste}</label>
                                </div>
                                <div >
                        ...
                        <div className="d-flex justify-content-around mt-5 ingredients-and-preparation-holder col-12">
                            <div className="fs-4">
