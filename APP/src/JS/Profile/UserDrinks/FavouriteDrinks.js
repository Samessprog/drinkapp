...
function FavouriteDrinks({ name }) {
    ...
    return (
        <div className="user-drink-holder mt-4 col col-5 col-sm-3 col-md-3 col-xl-2  me-3 e">
                        ...
                        <div class="d-flex  flex-column justify-content-center align-items-center">
                            <div className="cc d-flex  flex-column justify-content-center align-items-center">
                                ...
                                <div className="d-flex mt-3">
                                    <label className="me-4 drink-level" >Easy</label>
                                    <label className="drink-taste">Sour</label>
                                </div>
                                <label className=" mt-3 drink-type ">Alcoholic</label>
                            </div>
                        </div>
                    </div>
                </div>
